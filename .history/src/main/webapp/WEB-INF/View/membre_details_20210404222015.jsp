...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Détails du membre n°${member.getId()}</h5> 
        <div class="row">
	      <form action="/TP3Ensta/membre_details?id=${member.getId()}" method="post" class="col s12"> 
	        <div class="row">
	          <div class="input-field col s4">
	            <input id="nom" type="text" value="${member.getNom()}" name="nom"> <!-- TODO : remplacer nomDuMembre par le nom du membre -->
	            <label for="nom">Nom</label>
	          </div>
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="${member.getPrenom()}" name="prenom"> <!-- TODO : remplacer prenomDuMembre par le pr�nom du membre -->
