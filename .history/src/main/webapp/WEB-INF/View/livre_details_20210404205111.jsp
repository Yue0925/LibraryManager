	      ...
	      <form action="/TP3Ensta/livre_details?id=${livre.getId()}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="titre" type="text" value="${livre.getTitle()}" name="titre"> <!-- TODO : remplacer titreDuLivre par le titre du livre -->
	            <label for="titre">Titre</label>
	          </div>
	        </div>
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="auteur" type="text" value="${livre.getAuthor()}" name="auteur"> <!-- TODO : remplacer auteurDuLivre par l'auteur du livre -->
        ...
        <div class="row">
          <div class="col s12">
	        <table class="striped">
              ...
              <tbody id="results">
                <c:if test="${!livresCourants.isEmpty()}">
                  <c:forEach items="${livresCourants}" var="livre">
                    <tr>
                      <td>${livre.getMembre().getPrenom()} ${livre.getMembre().getNom()}</td>
